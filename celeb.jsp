...
<!-- saved from url=(0053)file:///Users/shekhuansari/Desktop/ann_9/newfile.html -->
...
#img1{
 ...
 .frame{
      ...
      box-shadow: 0 0 21px 3px rgba(0, 0, 0, 0.5) insert, 0 15px 54px 10px rgba(0, 0, 0, 0.3);
      padding:16px;
      border-radius: 12px;
...
.fontclass{
    ...
    color:#e3d5ca;
    text-shadow: 0.025em 0.025em 0 yellow,
...
@keyframes example1{
 ...
 <section id="top">
    <div id="navdiv">
    <img id="img22" style="height:250px;width:250px;" src="flower-12.png"></div>
    <div id="another-nav">
        <img id="3" style="height:300px;width:500px;" src="3flwr.png">
    </div>
     
  <h1 class="anton-sc-regular">Hello <%= name %> </h1>
 <h2 class="playwrite-us-trad-cursive">My beloved, You are the epitome of beauty inside out</h2><h2> 
  <div class="frame">
...
<div class="block b1" style="background-image: url(bg.png);">
    
</div>
<div class="block b1" style="background-image: url(bg2.png);background-size: 310px 200px;"></div>

<div class="block b2">
   <center><h2 class="playwrite-us-trad-cursive" style="color:#D2A82A;font-size:39px;padding-top:25px;">&#8592;belong&#8594;</h2><h2> </h2></center>
</div>
<div class="block b2">
...
<div class="block b2" style="border-start-end-radius:45px;border-end-start-radius: 45px;">
  <center><img id="heart" src="heart.gif"></center> <% if (!bgRemovedBase64.isEmpty()) { %>
...
<div class="block b3" style="background-image: url(bg3.png); background-size:500px;opacity: 80%;">
    <div id="bg_text">
      <h2 class="anton-sc-regular" style="color:beige;text-shadow:
-1px -1px 0 #000,
1px -1px 0 #000,
-1px 1px 0 #000,
1px 1px 0 #000;">  you are my <br> happy place </h2> 
    </div>
</div>
<div class="block b3" style="background-image: url(bg4.png);background-size: 300px;"></div>

<div class="block b4" >
  <center>  <h1 class="audiowide-regular" style="padding-top:30px;color:#BA8FDB; text-shadow: 0.025em 0.025em 0 yellow,
                 0.05em 0.05em 0 blue,
                 0.075em 0.075em 0 red,
                 0.1em 0.1em 0 black;"> Happy Anniversary</h1></center>
...
<div class="block b4" style="background-image: url(page.jpeg);background-size: 300px;background-repeat: no-repeat;">
</div>
</div>
<div>
